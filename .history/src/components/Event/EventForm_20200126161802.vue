                        ...
                        <v-layout row>
                         ...
                         <v-layout row>
                            ...
                            <v-checkbox
                               ...
                               :disabled="!pay"
                               label="Pay required"
                               v-model="this.cash"></v-text-field>
                        </v-layout>
                         <v-layout row>
                            <v-flex xs-12 offset-sm3 sm-3 col-4> 
                             ...
                             <v-checkbox
                               ...
                               value="Smart Casual"
                               label="Dresscode"
                               v-model="this.dress"></v-text-field>
                        </v-layout>
                         <v-layout row>
                            <v-flex xs-12 offset-sm3 sm-3 col-4> 
                                <v-text-field 
...
export default {
  ...
  data: function () {
    return {
        ...
        description: '',
        imageUrl: '',
        types: ['Event', 'Club', 'Bar/Restaurant', 'Open Air', 'Concert', 'Local/House Party'],
        pay: false,
        dresscode: false,
        dress: '',
        cash: '',
